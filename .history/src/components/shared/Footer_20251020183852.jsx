...
// ✅ Local data (you can replace with imports if needed)
const menuItems = [
  { name: "Home", path: "/" },
...
export default function Footer() {
  return (
    <footer className="py-12 px-6 md:px-14 bg-gradient-to-b from-white via-gray-50 to-white dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 flex flex-col items-center">
      {/* ✨ Call to Action Box */}
