...
export default function Skills() {
  ...
  return (
    <section className="relative md:w-full overflow-hidden py-12 bg-gradient-to-b from-white via-gray-50 to-white dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
