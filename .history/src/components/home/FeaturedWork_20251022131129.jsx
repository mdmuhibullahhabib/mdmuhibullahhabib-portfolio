...
const projects = [
  {
    ...
    imageUrl: "https://i.ibb.co/BV8WCDzH/aloron.png", // fixed URL
  },
  {
    title: "Weboria",
    number: "02",
    ...
    imageUrl: "https://i.ibb.co/FLBHPsf1/weboria.png", // fixed URL
  },
];
  ...
  return (
    <section className="py-16 bg-white">
      <div className="max-w-7xl mx-auto px-6">
        {/* Header */}
        <div className="flex flex-col md:flex-row justify-between items-start mb-12 gap-6 md:gap-0">
          <div>
              ...
              <div className="flex flex-col md:flex-row items-center md:items-start gap-8 md:gap-12">
                ...
                <div className="md:w-1/2 space-y-4">
                  <h3 className="text-xl font-semibold text-gray-900">
                    {project.title}{" "}
                    <span className="text-gray-400 font-normal">({project.number})</span>
                  </h3>
                  ...
                  <div className="flex flex-wrap gap-3 mt-4">
                    ...
                    >
                      Live Project <GoArrowUpRight className="text-white text-base" />
                    </a>
                    ...
                    >
                      Source Code <FaGithub className="text-gray-600 text-base" />
                    </a>
                  </div>
                </div>
