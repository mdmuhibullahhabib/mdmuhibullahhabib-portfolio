                ...
                <div className="md:w-1/2 space-y-4">
                  ...
                  <div className="flex flex-wrap gap-3 mt-4">
                    <a
                      ...
                      className="px-4 py-1.5 text-sm font-medium text-white rounded-full bg-gradient-to-r from-purple-600 to-pink-500 hover:from-purple-700 hover:to-pink-600 transition"
                    >
                      Live Project
                    </a>
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="px-4 py-1.5 text-sm font-medium text-gray-700 rounded-full border border-gray-300 hover:bg-gray-100 transition"
                    >
                      Source Code
                    </a>
                    <button
                      disabled
                      className="px-4 py-1.5 text-sm font-medium text-gray-400 rounded-full border border-gray-200 cursor-not-allowed"
                    >
                      View Details
                    </button>
                  </div>
