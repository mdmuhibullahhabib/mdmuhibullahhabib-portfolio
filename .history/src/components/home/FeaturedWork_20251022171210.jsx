  ...
  return (
    <section className="py-16 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Section Header */}
        <div className="flex flex-col md:flex-row md:justify-between md:items-start mb-12 text-center md:text-left gap-6">
          <div>
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-2">
              FEATURED WORK
            </h2>
            <p className="text-gray-600 max-w-xl mx-auto md:mx-0 text-sm md:text-base leading-relaxed">
          ...
          <Link
            href="/contact"
            className="flex items-center justify-center gap-2 text-purple-600 font-medium border border-purple-600 px-5 py-2 rounded-full hover:bg-purple-50 transition"
          >
              ...
              <div
                className={`flex flex-col ${
                  idx % 2 === 1
                    ? "md:flex-row-reverse"
                    : "md:flex-row"
                } items-center md:items-center gap-8 md:gap-12`}
              >
                {/* Info Section */}
                ...
                <div className="w-full md:w-1/2 flex justify-center md:justify-end">
                  <div className="relative w-full h-[220px] sm:h-[280px] md:h-[300px] lg:h-[360px] border border-gray-200 rounded-xl overflow-hidden shadow-sm hover:shadow-md transition">
                    <Image
