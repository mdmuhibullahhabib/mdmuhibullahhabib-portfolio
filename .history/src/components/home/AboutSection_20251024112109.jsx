...
export default function AboutSection() {
  return (
    <section className="bg-white text-black pt-18 pb-8 px-4 sm:px-6 lg:px-12 overflow-x-hidden">
      <div className="container mx-auto flex flex-col md:flex-row items-center gap-8 md:gap-12">
        ...
        >
          ...
          <p className="text-gray-700 text-sm sm:text-base mb-4 sm:mb-6 leading-relaxed">
            ...
            <span className="font-semibold text-blue-600">NextAuth.js, Firebase and JWT</span>, and data management
