...
export default function HeroSection() {
    ...
    return (
        <section className="bg-white pt-4 min-h-screen flex items-center">
            <div className="container mx-auto px-6 md:flex md:items-center md:justify-between">
                ...
                <div className="md:w-1/2 mb-12 md:mb-0">
                    ...
                    <p className="text-gray-600 text-lg md:text-xl mb-6">
                        I connect real-world problems to scalable, accessible software, building with <span className="text-purple-600 font-medium">React/Next.js • JavaScript • Node/Express</span> and modern databases.
                    </p>
                ...
                <div className="relative w-full lg:w-1/2 flex justify-center">
                    <div className="h-[500px] lg:w-[400px] max-md:h-96 overflow-hidden rounded-b-full shadow-2xl border border-white/5">
                        <Image
                            src={image}
                            alt="Profile Image"
                            width={400}
