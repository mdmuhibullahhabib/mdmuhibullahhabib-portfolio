            ...
            <div className="container mx-auto px-6 md:flex md:items-center md:justify-between">
                ...
                <div className="md:w-1/2 mb-12 md:mb-0">
                    ...
                    <p className="text-gray-600 text-lg md:text-xl mb-6">
                        I connect real-world problems to scalable, accessible software, building with <span className="text-purple-600 font-medium">React/Next.js • Script • Node/Express</span> and modern databases.
                    </p>
