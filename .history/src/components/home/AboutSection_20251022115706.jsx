    ...
    <section className="bg-white py-24">
      <div className="container mx-auto px-6 md:flex md:items-center md:gap-12">
        ...
        >
          ...
          {/* Learn More Button */}
          <Link to="" className="px-8 py-3 border-2 border-blue-600 text-blue-600 rounded-xl font-semibold hover:bg-blue-600 hover:text-white transition duration-300">
            Learn More
          </Link>
        </motion.div>
