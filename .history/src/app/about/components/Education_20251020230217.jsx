...
export default function Education() {
  ...
  return (
    <section className="w-full my-16 px-4 py-16 bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900">
      ...
      <div className="flex gap-6 justify-center mt-12">
        <a href="mailto:example@email.com" aria-label="Email" className="hover:text-purple-400 transition text-2xl text-gray-400">
          <FaEnvelope />
        </a>
        <a href="https://github.com/yourprofile" target="_blank" aria-label="GitHub" className="hover:text-purple-400 transition text-2xl text-gray-400">
          <FaGithub />
        </a>
        <a href="https://linkedin.com/in/yourprofile" target="_blank" aria-label="LinkedIn" className="hover:text-purple-400 transition text-2xl text-gray-400">
          <FaLinkedin />
        </a>
      </div>
    </section>
