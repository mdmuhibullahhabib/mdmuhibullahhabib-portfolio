      ...
      <div className="container mx-auto px-6 md:flex md:items-center md:justify-between">
        ...
        <div className="md:w-1/2 mb-12 md:mb-0">
          ...
          <div className="flex items-center gap-6 text-gray-700">
            <a href="https://github.com/" target="_blank" rel="noopener noreferrer" className="hover:text-purple-600 transition">GitHub</a>
            <a href="https://linkedin.com/" target="_blank" rel="noopener noreferrer" className="hover:text-purple-600 transition">LinkedIn</a>
            <a href="mailto:example@email.com" className="hover:text-purple-600 transition">Email</a>
          </div>
        </div>
